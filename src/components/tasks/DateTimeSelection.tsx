...
export const DateTimeSelection = ({
  ...
  return (
    <div className="grid gap-2">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Checkbox 
            id="noDueDate" 
            checked={noDueDate}
            onCheckedChange={onNoDueDateToggle}
          />
          <Label htmlFor="noDueDate" className="text-sm">No due date</Label>
        </div>
      </div>

      <div className={`grid grid-cols-[1fr,auto] gap-2 ${noDueDate ? 'opacity-50 pointer-events-none' : ''}`}>
        <Popover>
      ...
      <div className={`flex items-center gap-2 ${noDueDate ? 'opacity-50 pointer-events-none' : ''}`}>
