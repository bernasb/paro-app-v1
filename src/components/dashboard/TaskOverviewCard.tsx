      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3">
          {sortedTasks.map((task) => (
            <div key={task.id} className="flex items-start gap-3 p-3 rounded-md bg-accent/20 border border-border">
              <div className="flex-1 flex">
                ...
                <div className="min-w-[100px]">
                  <div className="flex justify-between items-center mb-2">
                    <Label htmlFor={`urgent-overview-${task.id}`} className="text-xs text-left">Urgent</Label>
                    <Checkbox 
                  ...
                  <div className="flex justify-between items-center">
                    <Label htmlFor={`important-overview-${task.id}`} className="text-xs text-left">Important</Label>
                    <Checkbox 
